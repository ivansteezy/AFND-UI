...
// all of this can be refactor to make at compiletime
void Core::GraphBuilder::GenerateDirections()
{
	...
	std::vector<Direction> directionsNode1{ direction1Node1 , direction2Node1 , direction3Node1 };
	...
	std::vector<Direction> directionsNode12{ direction1Node12 , direction2Node12, direction3Node12 };
	...
	std::vector<Direction> directionsNode18{ direction1Node18 , direction2Node18 , direction3Node18 };
